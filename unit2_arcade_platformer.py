...
#         # initiate new scene with TileMap, this will automatically add all layers
...
#         self.scene.add_sprite_list(LAYER_NAME_MOVING_PLATFORMS)
...
SCREEN_WIDTH = 1000
SCREEN_HEIGHT = 650
SCREEN_TITLE = "The Voracious March Of Godliness"
